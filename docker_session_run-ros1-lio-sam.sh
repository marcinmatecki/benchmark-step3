...
DATASET_CONTAINER_PATH='/ros_ws/dataset/recorded-lio-sam.bag'
...
roslaunch lio_sam run.launch use_sim_time:=true
'\'' C-m
...
source /ros_ws/devel/setup.bash
echo "[record] start"
rosbag record /lio_sam/mapping/cloud_registered /odometry/imu -O '"$BAG_OUTPUT_CONTAINER/$RECORDED_BAG_NAME"'
echo "[record] exit"
'\'' C-m
